...
public class HintSQLHandler implements HintHandler {
	...
	public RouteResultset route(SystemConfig sysConfig, SchemaConfig schema,
		...
		/*realSQLCheck(sysConfig, schema, sqlType,
				realSQL, charset, sc, cachePool,rrs);
		*/
		// 替换RRS中的SQL执行
	...
	private void realSQLCheck(SystemConfig sysConfig, SchemaConfig schema,
			int sqlType, String realSQL, String charset, ServerConnection sc,
			LayerCachePool cachePool, RouteResultset rrs) {
		try {
			routeStrategy.route(sysConfig, schema, sqlType,
