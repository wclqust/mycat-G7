...
public class MycatServer {
	...
	// 加密解密缓存 key为schemaname|tablename|columnname; value为CrytoAlgorithm的实现类
	private final ConcurrentMap<String, CrytoAlgorithm> crytoCacheMap;
	...
	public ConcurrentMap<String, CrytoAlgorithm> getCrytoCacheMap() {
