...
public class MycatSchemaStatVisitorTest {
	public static void main(String[] args) {
		String sql="insert into t_user(id,name,email,created_at,updated_at) select id,name,email,created_at,updated_at from t2_user;";
		...
		DruidInsertParser druidInsertParser=new DruidInsertParser();
		//druidInsertParser.statementParse(schema, rrs, stmt))
	...
	public void test1() {
		...
		sql="insert into t_user(id,name,email,created_at,updated_at) select id,name,email,created_at,updated_at from t2_user;";
		SQLStatementParser sqlstatementParser=new MySqlStatementParser(sql); 
		SQLStatement statement=sqlstatementParser.parseStatement();
		MycatSchemaStatVisitor visitor= new MycatSchemaStatVisitor();
		statement.accept(visitor);
